...
/**
 * Sanitize an HTML email body: strip unsafe tags/attributes, then force all
 * links to open in a new tab so users don't navigate away from the app.
 */
function sanitizeEmailHtml(html: string): string {
	...
	// Post-process: ensure every anchor opens in a new tab with safe referrer policy
