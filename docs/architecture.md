...
4. **Read-only by default.** The sync engine never modifies the IMAP server unless the user explicitly opts in to connector mode. Safe to point at a production mailbox.
